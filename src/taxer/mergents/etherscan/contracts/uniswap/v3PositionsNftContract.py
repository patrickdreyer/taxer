...
class V3PositionsNftContract(Contract):
    ...
    def processTransaction(self, address, id, year, transaction, erc20Transaction):
        ...
        if name == 'multicall':
            ...
            if innerName == 'mint':
                ...
                poolId = int(innerArgs['params']['tokenId'])
    ...
    def __mint(self, id, year, transaction, args):
        contract0 = self.__contracts.getByAddress(args['params']['token0'])
        contract1 = self.__contracts.getByAddress(args['params']['token1'])
        ...
        poolId = Web3.to_int(hexstr=increaseLiquidityLog['topics'][1])
        liquidity = output['liquidity']
