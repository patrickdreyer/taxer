...
class CancelFeeStrategy(BananaStrategy):
    ...
    def transform(self, transaction):
        ...
        yield BananaStrategy._createBooking(transaction, ['Abbruchgebühr', self.__accounts.fees, c.account,  c.amount, c.unit,   c.baseCurrency.exchangeRate, c.baseCurrency.amount, '',     c.costCenter.minus()])
